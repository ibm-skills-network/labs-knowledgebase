...
- Databases (Cloud IDE with Kubernetes or OpenShift only)
  - MySQL
  - PostgreSQL
  - Cassandra
  - MongoDB
...
- Embeddable AI
  ...
  - Watson NLP
    ...
    - Syntax
- Launch Application - This is how you view the application you run within Cloud IDE. It starts a proxy server that makes an application running inside the IDE reachable from your browser. You can serve the application with the built-in live server or with a framework's own server (for example, Flask for Python or Express for Node.js).
